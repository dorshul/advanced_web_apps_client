  ...
  const onSubmit = async (data: {
    ...
    try {
      if (existingPost) {
        ...
        await createPost({ post: { content: data.content, title: data.title }, img: data.img! });
      }
      reset();
      navigate("/explore");
    } catch (err: unknown) {
        ...
        >
          ...
          { isCreatePending || isUpdatePending ? 
            <Typography>Uploading...</Typography> 
              : 
            <Button type="submit" variant="contained">Upload Post</Button> 
          }
        </Box>
